...
contextBridge.exposeInMainWorld("ccr", {
  ...
  listMcpServerTools: (serverName: string) => ipcRenderer.invoke(IPC_CHANNELS.appListMcpServerTools, serverName) as Promise<GatewayMcpToolInfo[]>,
  ...
  stopProfile: (request: ProfileOpenRequest) => ipcRenderer.invoke(IPC_CHANNELS.appStopProfile, request) as Promise<ProfileStopResult>,
