...
const zh = {
  ...
  "automations.approval": "审批",
  "automations.body": "Body",
  "automations.cancel": "取消",
  "automations.close": "关闭",
  "automations.condition": "条件",
  "automations.condition.jsonEquals": "JSON 等于",
  "automations.condition.jsonExists": "JSON 存在",
  "automations.condition.textContains": "文本包含",
  "automations.concurrency": "并发",
  "automations.concurrency.queue": "排队重叠任务",
  "automations.concurrency.skip": "跳过重叠任务",
  "automations.cron": "Cron",
  "automations.currentWorkspace": "当前工作区",
  "automations.default": "默认",
  "automations.definition": "定义",
  "automations.dedupePath": "去重路径",
  "automations.delete": "删除",
  "automations.deleted": "自动化任务已删除。",
  "automations.dialog.editTitle": "编辑自动化任务",
  "automations.dialog.newTitle": "新建自动化任务",
  "automations.disabled": "已禁用",
  "automations.edit": "编辑",
  "automations.editNamed": "编辑 {name}",
  "automations.enabled": "已启用",
  "automations.every": "间隔",
  "automations.interval.10s": "10 秒",
  "automations.interval.15m": "15 分钟",
  "automations.interval.1d": "1 天",
  "automations.interval.1h": "1 小时",
  "automations.interval.1m": "1 分钟",
  "automations.interval.1s": "1 秒",
  "automations.interval.30s": "30 秒",
  "automations.interval.5m": "5 分钟",
  "automations.interval.5s": "5 秒",
  "automations.method": "方法",
  "automations.model": "模型",
  "automations.name": "名称",
  "automations.new": "新建自动化",
  "automations.noTasks": "暂无自动化任务",
  "automations.path": "路径",
  "automations.project": "项目",
  "automations.prompt": "提示词",
  "automations.provider": "Provider",
  "automations.run": "运行",
  "automations.runNamed": "运行 {name}",
  "automations.runStarted": "运行已启动。",
  "automations.save": "保存",
  "automations.saved": "自动化任务已保存。",
  "automations.secret": "Secret",
  "automations.slug": "Slug",
  "automations.state": "状态",
  "automations.tasks": "任务",
  "automations.thread": "会话",
  "automations.thread.new": "每次新建",
  "automations.thread.reuse": "复用",
  "automations.timezone": "时区",
  "automations.title": "自动化",
  "automations.trigger": "触发器",
  "automations.triggerType.cron": "Cron",
  "automations.triggerType.interval": "Interval",
  "automations.triggerType.poll": "Poll",
  "automations.triggerType.webhook": "Webhook",
  "automations.url": "URL",
  "automations.value": "值",
  "agent.allow": "允许本次",
  ...
  "agent.abortRunFailed": "停止运行失败。",
  "agent.abortRunUnavailable": "当前运行还没有可停止的 runId，请稍后再试。",
  ...
  "rightSidebar.closeTabAria": "关闭 {label} 标签页",
  ...
  "settings.subagents.budgetInvalid": "预算限制必须是正整数。",
  "settings.subagents.capabilities": "能力",
  "settings.subagents.capabilitiesPlaceholder": "代码审查\n测试修复\n性能分析",
  "settings.subagents.configure": "设置 {agent}",
  "settings.subagents.contextScope": "上下文范围",
  "settings.subagents.contextScopePlaceholder": "说明这个 worker 应该优先读取或忽略的上下文。",
  ...
  "settings.subagents.maxDurationMs": "最长耗时 ms",
  "settings.subagents.maxTokens": "Token 预算",
  "settings.subagents.maxToolCalls": "工具调用上限",
  "settings.subagents.newSubagent": "新建 Subagent",
  "settings.subagents.noTools": "还没有工具 MCP。",
  "settings.subagents.outputContract": "输出契约",
  "settings.subagents.outputContractPlaceholder": "例如：必须输出风险列表、补丁摘要和验证结果。",
  "settings.subagents.provider": "基础 Agent",
  "settings.subagents.providerMode.emulated": "Subagent 模拟",
  "settings.subagents.providerMode.native": "原生 Subagent",
  "settings.subagents.providerMode.none": "无 Subagent 能力",
  "settings.subagents.providerRuntimeFallback": "该 provider 未声明更详细的运行时能力。",
  "settings.subagents.providerRequired": "请选择基础 Agent。",
  "settings.subagents.qualityGates": "质量门槛",
  "settings.subagents.qualityGatesPlaceholder": "必须运行相关测试\n必须列出残余风险",
  "settings.subagents.runtime.auto": "自动",
  "settings.subagents.runtime.emulated": "强制模拟",
  "settings.subagents.runtime.native": "优先原生",
  "settings.subagents.runtimeMode": "运行模式",
...
const en = {
  ...
  "automations.agent": "Agent",
  "automations.approval": "Approval",
  "automations.body": "Body",
  "automations.cancel": "Cancel",
  "automations.close": "Close",
  "automations.condition": "Condition",
  "automations.condition.jsonEquals": "JSON equals",
  "automations.condition.jsonExists": "JSON exists",
  "automations.condition.textContains": "Text contains",
  "automations.concurrency": "Concurrency",
  "automations.concurrency.queue": "Queue overlap",
  "automations.concurrency.skip": "Skip overlap",
  "automations.cron": "Cron",
  "automations.currentWorkspace": "Current workspace",
  "automations.default": "Default",
  "automations.definition": "Definition",
  "automations.dedupePath": "Dedupe path",
  "automations.delete": "Delete",
  "automations.deleted": "Automation deleted.",
  "automations.dialog.editTitle": "Edit automation task",
  "automations.dialog.newTitle": "New automation task",
  "automations.disabled": "Disabled",
  "automations.edit": "Edit",
  "automations.editNamed": "Edit {name}",
  "automations.enabled": "Enabled",
  "automations.every": "Every",
  "automations.interval.10s": "10 seconds",
  "automations.interval.15m": "15 minutes",
  "automations.interval.1d": "1 day",
  "automations.interval.1h": "1 hour",
  "automations.interval.1m": "1 minute",
  "automations.interval.1s": "1 second",
  "automations.interval.30s": "30 seconds",
  "automations.interval.5m": "5 minutes",
  "automations.interval.5s": "5 seconds",
  "automations.method": "Method",
  "automations.model": "Model",
  "automations.name": "Name",
  "automations.new": "New automation",
  "automations.noTasks": "No automation tasks",
  "automations.path": "Path",
  "automations.project": "Project",
  "automations.prompt": "Prompt",
  "automations.provider": "Provider",
  "automations.run": "Run",
  "automations.runNamed": "Run {name}",
  "automations.runStarted": "Run started.",
  ...
  "automations.thread": "Thread",
  "automations.thread.new": "New each run",
  "automations.thread.reuse": "Reuse",
  ...
  "agent.abortRunFailed": "Failed to stop the run.",
  "agent.abortRunUnavailable": "This run does not have a stoppable runId yet. Try again in a moment.",
  ...
  "rightSidebar.git.label": "Git",
  "rightSidebar.git.title": "Git",
  "rightSidebar.closeTabAria": "Close {label} tab",
  ...
  "settings.subagents.budgetInvalid": "Budget limits must be positive integers.",
  "settings.subagents.capabilities": "Capabilities",
  "settings.subagents.capabilitiesPlaceholder": "Code review\nTest repair\nPerformance analysis",
  "settings.subagents.configure": "Configure {agent}",
  "settings.subagents.contextScope": "Context scope",
  "settings.subagents.contextScopePlaceholder": "Describe which context this worker should prefer or ignore.",
  ...
  "settings.subagents.maxDurationMs": "Max duration ms",
  "settings.subagents.maxTokens": "Token budget",
  "settings.subagents.maxToolCalls": "Tool call limit",
  "settings.subagents.newSubagent": "New Subagent",
  "settings.subagents.noTools": "No tool MCPs yet.",
  "settings.subagents.outputContract": "Output contract",
  "settings.subagents.outputContractPlaceholder": "Example: return risks, patch summary, and verification results.",
  "settings.subagents.provider": "Base Agent",
  "settings.subagents.providerMode.emulated": "Emulated subagents",
  "settings.subagents.providerMode.native": "Native subagents",
  "settings.subagents.providerMode.none": "No subagent support",
  "settings.subagents.providerRuntimeFallback": "This provider has not declared detailed runtime capabilities.",
  "settings.subagents.providerRequired": "Choose a base agent.",
  "settings.subagents.qualityGates": "Quality gates",
  "settings.subagents.qualityGatesPlaceholder": "Run relevant tests\nList residual risks",
  "settings.subagents.runtime.auto": "Auto",
  "settings.subagents.runtime.emulated": "Force emulated",
  "settings.subagents.runtime.native": "Prefer native",
  "settings.subagents.runtimeMode": "Runtime mode",
