...
export const appCopy: Record<ResolvedLanguage, AppCopy> = {
  ...
  zh: {
    ...
    text: {
      ...
      "Browser JSON request": "浏览器 JSON 请求",
      ...
      "Browser JSON request uses CCR Desktop's built-in browser login state. Sign in in the in-app browser before testing.": "浏览器 JSON 请求会使用 CCR Desktop 内置浏览器的登录态。测试前请先在内置浏览器中登录。",
