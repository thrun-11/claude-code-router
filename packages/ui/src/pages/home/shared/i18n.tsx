...
export const appCopy: Record<ResolvedLanguage, AppCopy> = {
  en: {
    ...
    text: {
      ...
      "Protocol detection checks compatibility; connection verification confirms a real model request succeeds.": "Protocol detection checks compatibility; connection verification confirms a real model request succeeds.",
      ...
      "Run Check Connection before relying on this provider.": "Run Check Connection before relying on this provider.",
      ...
      "50 / page": "50 / page",
      "100 / page": "100 / page",
      "Agent observability is off": "Agent observability is off",
      "Agent observability records session metadata, routing decisions, tools, and errors for diagnosis.": "Agent observability records session metadata, routing decisions, tools, and errors for diagnosis.",
      ...
      "Enable agent observability": "Enable agent observability",
      ...
      "Open log": "Open log",
      "Open request log": "Open request log",
  ...
  zh: {
    ...
    text: {
      ...
      "Agent observability is off": "Agent 观测已关闭",
      "Agent observability records session metadata, routing decisions, tools, and errors for diagnosis.": "Agent 观测会记录会话元数据、路由决策、工具调用和错误，便于诊断。",
      "All agents": "全部 Agent",
      "All models": "全部模型",
      "All providers": "全部供应商",
      "API key": "API 密钥",
      ...
      "Effect scope": "作用范围",
      "Enable": "启用",
      "Enable agent observability": "启用 Agent 观测",
      ...
      "Protocol detection checks compatibility; connection verification confirms a real model request succeeds.": "协议探测只确认兼容性；连通性验证会确认真实模型请求可以成功。",
      ...
      "Run Check Connection before relying on this provider.": "使用前建议先运行检测连通性。",
