...
export const appCopy: Record<ResolvedLanguage, AppCopy> = {
  en: {
    ...
    text: {
      ...
      "CCR scanned this computer for local Claude Code, Codex, Grok CLI, OpenCode CLI, and ZCode providers. Click Import to add one as a gateway provider.": "CCR scanned this computer for local Claude Code, Codex, Grok CLI, OpenCode CLI, and ZCode providers. Click Import to add one as a gateway provider.",
      "Locked": "Locked",
  ...
  zh: {
    ...
    text: {
      ...
      "CCR scanned this computer for local Claude Code, Codex, Grok CLI, OpenCode CLI, and ZCode providers. Click Import to add one as a gateway provider.": "CCR 已扫描本机的 Claude Code、Codex、Grok CLI、OpenCode CLI 和 ZCode 供应商。点击导入即可添加为网关供应商。",
      "Locked": "已加密",
      ...
      "error": "错误",
      "noop": "无变更",
      "Request ingress": "请求接入",
      "Header normalization": "请求头规范化",
      "Protocol adaptation": "协议适配",
      "Route decision": "路由决策",
      "Request rewrite": "请求改写",
      "Model selection": "模型选择",
      "Route output": "路由输出",
      "Capability routing": "能力路由",
      "Content length normalization": "正文长度规范化",
      "Execution plan": "执行计划",
      "Prepare upstream": "准备上游调用",
      "Upstream result": "上游调用结果",
      "Cursor compatibility": "Cursor 兼容处理",
      "Codex patch compatibility": "Codex Patch 兼容处理",
      "Claude Code model discovery": "Claude Code 模型发现",
      "Claude App model discovery": "Claude App 模型发现",
      "Web search enrichment": "网页搜索增强",
      "Web search continuation": "网页搜索续接",
      "Custom router": "自定义路由",
      "add": "新增",
      "replace": "替换",
      "remove": "移除",
